"""add jury_comment for Ratings

Revision ID: bf3799bcf1b7
Revises: 
Create Date: 2026-01-04 16:59:25.452975
...
def upgrade():
    ...
    sa.Column('jury_comment', sa.String(length=254), nullable=True),
